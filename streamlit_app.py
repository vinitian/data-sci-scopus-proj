...
df = pd.read_csv("csv_and_json/df.csv", index_col=0)
df2 = pd.read_csv("csv_and_json/df2.csv", index_col=0)
df3 = pd.read_csv("csv_and_json/df3.csv", index_col=0)
df4 = pd.read_csv("csv_and_json/df4.csv", index_col=0)
...
subjdf = pd.read_csv("csv_and_json/uniqueCountSubjArea.csv", index_col=0)
...
ogfdf = pd.read_csv("csv_and_json/funderSubjArea.csv", index_col=0)
